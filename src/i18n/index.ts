...
const resources = {
  ar: {
    translation: {
      ...
      "contact.followFacebook": "تابعنا على فيسبوك",
      "contact.followInstagram": "تابعنا على انستغرام",
  ...
  fr: {
    translation: {
      ...
      "contact.followFacebook": "Suivez-nous sur Facebook",
      "contact.followInstagram": "Suivez-nous sur Instagram",
