...
const resources = {
  ar: {
    translation: {
      ...
      "benefits.teachers.feature1": "تسجيل حضور سريع وسهل",
      "benefits.teachers.feature2": "إدارة الصفوف والمجموعات",
      "benefits.teachers.feature3": "التواصل المباشر مع الأولياء",
      "benefits.teachers.feature4": "متابعة تقدم الطلاب",
      ...
      "trust.algeriaCompliance.title": "متوافق مع الجزائر",
      "trust.algeriaCompliance.description":
        "مصمم خصيصاً للنظام التعليمي الجزائري",
      "trust.rtlSupport.title": "دعم RTL كامل",
      ...
      "carousel.subtitle": "اكتشف كيف يمكن لـ OnSchool تبسيط إدارة مدرستك أو مركز التدريب",
  ...
  fr: {
    translation: {
      ...
      "benefits.teachers.feature1":
        "Enregistrement de présence rapide et facile",
      "benefits.teachers.feature2": "Gestion des classes et groupes",
      "benefits.teachers.feature3": "Communication directe avec les parents",
      "benefits.teachers.feature4": "Suivi des progrès des étudiants",
  ...
  en: {
    translation: {
      ...
      "benefits.teachers.feature1": "Quick and easy attendance recording",
      "benefits.teachers.feature2": "Classroom and group management",
      "benefits.teachers.feature3": "Direct communication with parents",
      "benefits.teachers.feature4": "Student progress tracking",
