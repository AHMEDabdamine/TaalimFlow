          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="flex items-center justify-center">
                <img
                  src="/attached_assets/image-eP5KQCJDDuVeP72aHPCoeYD7Z9qWzZ-3_1756726136337.webp"
                  alt="Education Platform - Laptop and Books"
                  className="w-full max-w-lg h-auto transform hover:scale-105 transition-transform duration-300 drop-shadow-2xl"
                />
              </div>
            </div>
          </div>
            ...
            <Card className="bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-blue-600 mt-1 flex-shrink-0" />
                  <span className="text-blue-700 dark:text-blue-300">
                    {t("benefits.teachers.feature3")}
                  </span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-blue-600 mt-1 flex-shrink-0" />
                  <span className="text-blue-700 dark:text-blue-300">
                    {t("benefits.teachers.feature4")}
                  </span>
                </div>
              </CardContent>
            </Card>
